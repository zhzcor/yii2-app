...
}function q(){var i=[];r.children("li.success").each(function(){i.push(a(this).data("url"))});if(r.children("li").not(".add").size()>=B.num&&B.num>1){A.hide()}else{A.show()}if(r.children("li").not(".add").size()==0){r.addClass("empty")}b.val(i.join(","))}function z(i){i.fadeOut(333,function(){i.remove();q()});r.data("num",r.data("num")-1)}}})(jQuery);